...
function GamemodeInfo:constructor(Id)
  ...
  self.m_JoinButton = GUIButton:new(self.m_Width*0.025, self.m_Height*0.9, self.m_Width*0.45, self.m_Height*0.08, "Gamemode beitreten", self.m_Window):setBackgroundColor(Color.Green)
  self.m_JoinButton.onLeftClick = function () triggerServerEvent("Event_JoinGamemode", localPlayer, Id) delete(self) end
  self.m_AbortButton = GUIButton:new(self.m_Width - self.m_Width*0.45 - self.m_Width*0.025, self.m_Height*0.9, self.m_Width*0.45, self.m_Height*0.08, "Abbrechen", self.m_Window):setBackgroundColor(Color.Red)
