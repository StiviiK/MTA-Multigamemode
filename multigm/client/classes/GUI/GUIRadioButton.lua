...
function GUIRadioButton:drawThis()
	...
	dxDrawImage(self.m_AbsoluteX, self.m_AbsoluteY, self.m_Height, self.m_Height, "res/images/GUI/Radiobutton.png")
	...
	if self.m_Checked then
		dxDrawImage(self.m_AbsoluteX, self.m_AbsoluteY, self.m_Height, self.m_Height, "res/images/GUI/Radiobutton_checked.png")
	end
