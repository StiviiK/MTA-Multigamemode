function Lobby:constructor()
  ...
  GamemodePed:new(0, Vector3(1713.793, -1663.490, 20.222), Vector3(0, 0, -90), 12, self:getSetting("Spawn").Interior, self)
  GamemodePed:new(0, Vector3(1729.256, -1647.652, 20.222), Vector3(0, 0, 90), 12, self:getSetting("Spawn").Interior, self)
  GamemodePed:new(0, Vector3(1729.256, -1655.511, 20.222), Vector3(0, 0, 90), 12, self:getSetting("Spawn").Interior, self)
end
