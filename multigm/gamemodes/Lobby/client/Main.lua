function Lobby:constructor()
  ...
  self:addSyncChangeHandler("Dimension", function (dim)
    ...
    GamemodePed:new(0, Vector3(1713.793, -1655.604, 20.222), Vector3(0, 0, -90), dim, self:getSetting("Spawn").Interior, GamemodeManager.getFromId(2))
    GamemodePed:new(0, Vector3(1713.793, -1663.490, 20.222), Vector3(0, 0, -90), dim, self:getSetting("Spawn").Interior, GamemodeManager.getFromId(3))
