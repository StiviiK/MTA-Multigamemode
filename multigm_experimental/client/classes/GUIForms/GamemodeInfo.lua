...
function GamemodeInfo:constructor(Id)
  ...
  self.m_HeaderPath = self.m_Gamemode and self.m_Gamemode:getSetting("HeaderPath") or "res/images/HeaderDefaultGamemode.png"
  if not fileExists(self.m_HeaderPath) then self.m_HeaderPath = "res/images/HeaderDefaultGamemode.png" end
